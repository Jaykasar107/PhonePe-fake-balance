...
class Checkbalance extends State<CheckBalance> {
  ...
  Column body() {
    return Column(
      children: [
        ...
        const Spacer(), // This pushes the UPI section to the bottom
        Container(
  ...
  AppBar toplayer(BuildContext context) {
    return AppBar(
      ...
      // Add this to get the back arrow functionality
      leading: IconButton(
      ...
      actions: [
        Padding(
          ...
          child: Container(
            ...
            child: const Icon(Icons.question_mark_sharp, color: Colors.white,size:20,),
          ),
        ),
      ],
    );
